---
type: concept
thesis: "Ngöndro (sNgon 'gro, 'before going') is the category of preliminary or foundational practice required at every level of Buddhist practice where the practitioner has not yet arrived at the experiential level a given teaching assumes. The word denotes a function, not a fixed liturgy — many different practice sets are called ngöndro depending on what they prepare for."
status: 🌱
domain: [tibetan-buddhism, meditation-practice]
importance: 6
confidence: established
tags: [preliminary, tibetan-term, curriculum]
aliases: [sNgon 'gro, preliminary practice, preliminaries, foundation practice]
...
Both deliver the practitioner to the same place — the [[Base of Dzogchen|base of Dzogchen]] (experience of nonduality). The Lama's instruction determines which route the student takes.
