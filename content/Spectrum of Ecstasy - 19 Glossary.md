---
type: source
thesis: "Spectrum of Ecstasy Glossary (20 pp, book pp. 277–296) — the book's technical-vocabulary reference. Defines ~150 Tibetan/Sanskrit terms used throughout the book with precise translations and conceptual specifications. Most entries already have dedicated wiki pages (khandro / pawo / dorje / pema / me-long / rinchen / khorlo / shi-nè / lha-tong / nyi'mèd / lhun-drüp / dzogchen / etc.). The glossary's distinctive contributions beyond what appears in the main-body chapters: formal paired definitions of **Method Display** (thabs rol pa'i ngang) and **Wisdom Display** (ye shes rol pa'i ngang) — the gendered externally-manifested-quality pair extending Ch.13; the canonical **Mere Indication** (man ngag, Skt. upadesha) definition — 'if one needs clarification, then one has not understood'; **Dagmedma** (Marpa's Dzogchen yogini consort); **Tashi Chhi-'dren** (Padmasambhava's tigress-consort accompanying Dorje Trollo); **Shakya Shri** (19th-c Drukpa Kagyüd gTérton); **Tu-mo** ('fierce woman'; yoga of spatial heat — practice of Milarepa, Rechungpa, and Khyungchen Aro Lingma). Also supplies the canonical Ri-med definition that prevents its common mis-reading as syncretism."
status: 🌱
domain: [nyingma, tantra, phenomenology, reference]
importance: 5
confidence: established
tags: [source-page, spectrum-of-ecstasy, glossary, reference, tibetan-terminology]
aliases: [SoE Glossary, Ch.Glossary, Spectrum of Ecstasy glossary]
sources: [raw/spectrum-of-ecstasy/19-glossary.md]
updated: 2026-04-24
---
...
1. **Transliteration** — Tibetan (in both Wylie and phonetic) + Sanskrit where available
2. **Short definition** — 1–3 sentences
3. **Cross-references** — to other glossary entries
...
The six-fold form of the Paramitas (first six of the ten). Complementary with the Ten Paramitas developed in [[Roaring Silence - 10 The Dimension of Nongradual Approach|Roaring Silence Ch.10]]. See [[Ten Paramitas]].
