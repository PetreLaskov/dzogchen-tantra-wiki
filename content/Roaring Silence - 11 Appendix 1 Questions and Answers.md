---
type: source
thesis: "Source page for *Roaring Silence* Ch.11 — the book's first appendix and the only chapter framed entirely as Q&A. Five thematic sections cover the *practical scaffolding* the main body left implicit: physical sitting (chair vs cushion; knees below hips; meditation shawl); temporal scaffolding (tsam = 'confines'; group/solitary retreat distinctions; weekend solitary as the unmarked maximum without a teacher; jé-thob post-meditation period); attuned intent (motivation without 'drag factor'; aerodynamic kindness-intention as gravitational counterweight to divorced individuation; method of no-method); kindness (the wisdom-compassion mirror argument; sympathy for the devil; love and compassion as one energy); and everyday-life integration (no inward/outward bias; no method, just being; ultimate vs relative view on noise; Velcro to intelligible sound; driving the car as the practice). The appendix's structural function: hand the practitioner the *life-architecture* in which the main body's practices can actually run."
status: 🌳
domain: [dzogchen, meditation-practice, sources]
importance: 9
confidence: established
tags: [source, primary-source, roaring-silence, ch11, appendix, q-and-a, practical, scaffolding, integration]
aliases: [Roaring Silence Ch.11, RS Ch.11, Appendix 1, Questions and Answers]
sources: [raw/roaring-silence/Roaring Silence - 11 Appendix 1 Questions and Answers.md]
updated: 2026-04-23
---

# Roaring Silence — Chapter 11: Appendix 1 — Questions and Answers

Source: `raw/roaring-silence/Roaring Silence - 11 Appendix 1 Questions and Answers.md`

The book's first appendix — and the only chapter that is *entirely* edited Q&A from formal teaching events (the main chapters interleave teaching prose with Q&A; this chapter is Q&A throughout). Structurally it sits between the completed main body (Ch.10) and the lineage description (Ch.12) / glossary (Ch.13). Its function is to deliver the *practical scaffolding* the main body's view-and-practice exposition deliberately set aside — sitting posture, retreat structure, daily-life integration, motivation, kindness — in a register that does not interrupt the curriculum-spine the main body builds.
...
- **Tsam = "confines."** *"The Tibetan word* tsam,*[footnote: mTshams] which is usually rendered as 'retreat,' actually means 'confines.' The idea is that you establish the* confines *in which you practice."* See [[Tsam|Tsam]]. Retreat can be solitary or in groups; can last an hour, a day, a week, a month, a year, three years, or any of these; can be open or closed.
...
- [[Tsam]] — *mTshams*; "confines"; the Ch.11 Q&A's substantive treatment of retreat structure
...
- [[Presence]] — *jé-thob* extends presence into post-meditation; world-as-teaching is presence integrated with ordinary life
...
- **Footnotes 2 and 3 deserve note**: footnote 2 specifies *red* (not maroon) as the Aro gTér color following Aro Lingma's instruction; footnote 3 names the Tirthika philosophical extremes (monism, dualism, nihilism, eternalism). Both extend material that was developed elsewhere in the wiki ([[Aro Ter]], potentially future stub for Tirthikas).

## Related

- [[Roaring Silence]] — the parent book
- [[Roaring Silence - 10 The Dimension of Nongradual Approach]] — the chapter Ch.11 immediately follows (and which completed the main body)
- [[Roaring Silence - 12 Appendix 2 The Confederate Sanghas of Aro]] — the next appendix
- [[Attuned Intent]], [[Tsam]], [[Jé-thob]], [[Kindness]] — new pages from this chapter
- [[Shi-nè]], [[Meditation Isn't Getting Used To Is]], [[Active and Passive Imagination]], [[Divorced Individuation]], [[Mistrust of Existence]], [[Presence]], [[Relaxation]] — main pages extended by this chapter
- [[Four Naljors]] — the curriculum the appendix scaffolds
- [[Dzogchen]] — the view of integration the appendix operationalizes
