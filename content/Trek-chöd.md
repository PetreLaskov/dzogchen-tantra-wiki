---
type: concept
thesis: "Trek-chöd (khregs chod) — 'cutting or blasting through' (also translatable as 'exploding the confines of conventional reality') — is one of the two main Dzogchen practices (paired with tögal / tögel). Named in Spectrum of Ecstasy Ch.12 as the lineage-term for the essentialised stare-into-the-arising-emotion method: 'In the practice of trek-chöd emotions are deliberately generated in order to stare into them.' Trek-chöd is the non-symbolic correlate of the Tantric method zap-lam. The practice is generation-of-sensation followed by taking-that-sensation-as-subject/object-of-meditation; the sensation is then realised as the liberated energy of the self-luminous primordial state. The Ch.12 'four-step method' (familiarise with view / internalise / catch yourself out / stare into the arising emotion) is an essentialisation of trek-chöd — the non-symbolic form through which any emotion arising in daily life can become the material of realisation. Ro-chig (one taste of emptiness and ecstasy) is the mystic-commitment whose sustenance makes trek-chöd viable."
status: 🌱
domain: [dzogchen, meditation-practice]
importance: 7
confidence: established
tags: [tibetan-term, dzogchen-technical, method, aro-lineage, nyingma, non-symbolic-route]
aliases: [khregs chod, trek chod, trek-cho, thregcho, thregchöd, cutting through, exploding conventional reality]
...
|---|---|
| Anger | Wisdom of clarity ([[Mirror-Wisdom|mirror-wisdom]]) |
...
Trek-chöd and tögal (its partner-practice, not treated in *Spectrum of Ecstasy*) are the two main practices of [[Me-ngag-dé|me-ngag-dé]] (the Series of Implicit Instruction) — the third of the three Dzogchen series:

- **[[Sem-dé|Sem-dé]]** (Mind Series) — ngöndro is the [[Four Naljors]]; preparatory.
- **[[Long-dé|Long-dé]]** (Space Series) — ngöndro includes sKu-mNye (the psycho-physical exercises mentioned in Ch.11 footnote 9).
- **[[Me-ngag-dé|Me-ngag-dé]]** (Series of Implicit Instruction) — contains trek-chöd and tögal as the main practices.

The ngöndro of Sem-dé prepares the practitioner for trek-chöd; trek-chöd prepares for tögal; tögal culminates in [[Thig-le|rainbow-body]] attainment.
