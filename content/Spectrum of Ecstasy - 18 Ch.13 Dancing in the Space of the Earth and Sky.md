---
type: source
thesis: "Spectrum of Ecstasy Ch.13 'Dancing in the Space of the Earth and Sky' — the book's closing chapter (20 pp, book pp. 257–276). Opens with the book's deepest ontological move: 'our emotions and our personal environment are the dance of the khandros and pawos. To know our reality as the dance of the khandros and pawos is to fall in love with them. To fall in love with them is to discover our beginningless enlightenment in the endless empty nature of their dance.' Develops dance-as-gendered-partnership (woman's dance is with pawo; man's dance is with khandro; pawo = form aspect of emptiness; khandro = emptiness aspect of form); dance-is-sexual (penetrate-and-engulf phenomenal reality); dance-never-stops. Installs the key Tantric metaphysical claim of non-dual multiplicity: 'everything, in its nature, is empty… also characterised by infinite variety… we are simultaneously dividedness and undividedness, from non-dual multiplicity.' Names the two yidam-vows (male tantrika vows to view phenomenal world as female / wisdom-display; female tantrika vows to view it as male / method-display). Supplies three iconographic descriptions of yidams — Yeshe Tsogyel (joyous female Buddha), Seng-ge Dongma (wrathful lion-headed khandro), Dorje Sempa (thunderbolt Mind-hero holding dorje + drilbu). Explicitly names Khandro-pawo-nyi-da-melong-gyud as part of Khyungchen Aro Lingma's gTerma cycle. Q&A addresses patriarchy in Buddhism (androcentric bias is product of culture not teaching; 'patriarchy is form'; no form of unenlightenment based on clinging to emptiness — clinging requires form); the three roots of Tantra issue (Lama / yidam / khandro is 'not coherent in Tantra' — should be Lama / yidam / pawo/khandro); emptiness/wisdom vs form/compassion relation; 'indications of how to look, not of what'; 'we recreate unenlightenment in each moment by trying to get back to enlightenment' (the paradox-of-return); phenomena as partner when no human partner; NR and KD perceiving from opposite poles as enhancement of relationship."
status: 🌱
domain: [nyingma, tantra, phenomenology, meditation-practice]
importance: 8
confidence: established
tags: [source-page, spectrum-of-ecstasy, aro-lineage, five-elements, khandro-pawo-nyi-da-melong-gyud, dance, book-closing, gendered-practice, yidam]
aliases: [SoE Ch.13, Dancing in the Space of the Earth and Sky, Ch.13 Spectrum of Ecstasy, book-closing chapter]
...
1. **Ontological** — our emotions and environment *are* the dance.
2. **Epistemic / Devotional** — to *know* this is to *fall in love* with them.
...
**The paradox-of-return**: the attempt to *return* to enlightenment itself *generates* unenlightenment in the moment of the attempt. [[Beginningless Enlightenment|Beginningless enlightenment]] cannot be returned to because there is no moment of having-strayed; the attempt-to-return is the straying. See [[Nongradual Approach]].
