---
type: concept
thesis: "Dzogchen recognizes three styles by which the enlightened state is communicated: oral (nyen gyüd), symbolic (da gyüd — formal and informal sub-styles), and direct / Mind-to-Mind (gong gyüd). Handbook and study can establish view, but the practice 'will bear no fruit' without transmission from a qualified, empowered Lama."
status: 🌿
domain: [dzogchen, nyingma]
importance: 7
confidence: established
tags: [foundational, transmission, tibetan-term, lama]
aliases: [three transmissions, three styles of transmission, nyen gyüd, da gyüd, gong gyüd]
sources: [raw/roaring-silence/Roaring Silence - 00c Introduction.md, raw/spectrum-of-ecstasy/10-ch05-reading-the-fields-of-our-energies.md, raw/spectrum-of-ecstasy/12-ch07-white-khandro-pawo-display.md]
updated: 2026-04-23
---
...
1. **Oral transmission** — *nyen gyüd* (sNyan brGyud)
2. **Symbolic transmission** — *da gyüd* (brDa brGyud), which has two modes:
   - **Formal symbolic** — *shedlung da* (bShad lung brDa)
   - **Informal symbolic** — *gyu-kyen da* (rGyu rKyen brDa)
3. **Direct (or Mind-to-Mind) transmission** — *gong gyüd* (dGongs brGyud)
...
| Aspect | Tibetan | Sense | Mode | Pertains to |
|---|---|---|---|---|
| **Wang** | *dbang* | empowerment, power | overpowering the sense fields with the splendour of symbolic display | ritual aspect of transmission |
| **Lung** | *lung* | sound, transmission-through-sound | sonic resonance linked with the vital force of rLung (spatial winds, prana) | hearing the ngak (mantra) and drub-thab (sadhana / ritual text) |
| **Tri** | *khrid* | explanation | integrating meaning through hearing | putting the method into practice |
...
**The Ch.7 refinement**: **symbolic transmission** is given its canonical instances explicitly — **the [[Me-long|me-long]]** (mirror) **or a crystal**. These are not the only possible symbolic-transmission objects, but they are the canonical ones in Dzogchen.
...
- [[Spectrum of Ecstasy - 12 Ch.7 White Khandro-Pawo Display]] — source for the Ch.7 reinstallation with me-long as canonical symbolic-transmission object
- [[Me-long]] — the canonical symbolic-transmission object in Dzogchen; mirror of Mind
- [[Aro Lingma]] — depicted holding the me-long with cho-phen (streamer of reality)
- [[rLung]] — spatial winds / prana; what *lung* transmission is linked with
