---
type: concept
thesis: "The Six Realms (rigs drug; 'six types of being') of Buddhist cosmology — gods (deva), demigods (asura), humans, animals, hungry ghosts (yidag / preta), and hell-beings — are reinterpreted in the Aro gTér / Nyingma view as 'essentially psychological perspectives or referential frames of karmic vision' (SoE Ch.11 footnote 1). Not literal realms as such, but modes of experience a being can transmigrate through, each characterised by a dominant affective-referential mode. Yidag (hungry ghost) names the specific mode of unsatisfiable craving — the extreme of the fire-element's grasping operation. The psychological-frame reading preserves doctrinal continuity (the Six Realms are the Buddhist map of samsaric-existence) while enabling practice-work at the experiential-register (a practitioner doesn't enter or leave realms by transmigration but by shifts in karmic vision)."
status: 🌱
domain: [buddhism, nyingma, phenomenology]
importance: 4
confidence: established
tags: [buddhist-cosmology, karmic-vision, psychological-frame, samsara, six-types-of-being]
aliases: [rigs drug, Six Realms of Samsara, Six Realms of Being, realms of being]
...
- **Fire-element fear-of-isolation** → *hungry ghost* mode (unsatisfiable craving; the Ch.8 *"no matter how often desire is consummated"* diagnostic)
- **Water-element fear-of-vulnerability** → *hell-being* mode (aggression-saturated; the Ch.7 *"Old Norse"* catalogue)
- **Air-element fear-of-obliteration** → *demigod / asura* mode (jealous-vigilance; paranoid power-competition)
- **Earth-element fear-of-poverty** → *god-realm* or *animal-realm* mode (materialism; instinct-dominated)
- **Space-element bewilderment** → *animal-realm* at its depressive-torpor end; or any realm collapsed into virtual-insentience
...
Each realm is a specific-form of [[Samsara|samsara]]. The practice is not to escape by transmigration to a better realm but to *recognise the karmic-vision-mechanism operating now* and allow the [[Distracted-Being and Liberated-Being|sparkling-through]] to dissolve it.
...
- [[Spectrum of Ecstasy - 16 Ch.11 Five-fold Display]] — source: footnote 1 definition
- [[Samsara]] — the general name for cyclic existence across the Six Realms
- [[Three Poisons]] — the karmic-vision-generators whose operations produce specific realms
- [[Five Elements]] — the element-neurosis taxonomy overlapping with realm-mapping
