---
type: source
thesis: "Source page for *Roaring Silence* Ch.13 — the book's closing reference section: 40 short entries giving authoritative Wylie transliterations and lineage-sanctioned short definitions for the Tibetan and Sanskrit terms the main body and appendices use. The glossary's distinctive contribution is threefold: (1) it *pins the Wylie*, making the spelling of each term unambiguous; (2) it hands down *canonical short definitions* in the Aro gTér register; (3) it reveals terms the body did not expand — principally *Me-ngag-dé* (the third Dzogchen series, the Series of Implicit Instruction), *Aro Naljor-zhi* as the Aro-specific name for the Four Naljors, and *ngak'phang* / *gö-kar chang-lo'i dé* as the formal names for the non-monastic-non-celibate ordained sangha whose members (ngakpa / ngakma) have been the book's running practitioner-model. The glossary does not introduce new doctrine; it finalizes the terminology."
status: 🌳
domain: [dzogchen, meditation-practice, sources]
importance: 7
confidence: established
tags: [source, primary-source, roaring-silence, ch13, glossary, back-matter, reference, terminology, wylie]
aliases: [Roaring Silence Ch.13, RS Ch.13, Glossary, Roaring Silence Glossary]
sources: [raw/roaring-silence/Roaring Silence - 13 Glossary.md]
updated: 2026-04-23
---
...
- **bodhicitta** — *"Literally, 'buddha mind.' Active compassion."* (The ultra-compact Sutra-reading gloss. "Active compassion" is the two-word summary of the Sutra-cultivation dimension of [[Changchub-sem|changchub-sem]].)
...
| Series | Wylie | Glossary definition |
|---|---|---|
| [[Sem-dé]] | sems sDe | *"The Series of the nature of Mind"* |
| [[Long-dé]] | kLong sDe | *"The Series of Space"* |
| [[Me-ngag-dé]] | man ngag sDe | *"The Series of Implicit Instruction"* |
...
- [[Roaring Silence]] — the parent book, whose processing is wrapped with this chapter
- [[Roaring Silence - 11 Appendix 1 Questions and Answers]] — the preceding chapter (last developed content)
- [[Me-ngag-dé]], [[Ngak'phang]], [[Aro Lingma]] — the three new pages seeded from this chapter
- [[Four Naljors]] — the Aro Naljor-zhi naming source
- [[Sem-dé]], [[Long-dé]] — the two previously-named Dzogchen series now joined by Me-ngag-dé
