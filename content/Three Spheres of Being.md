---
type: concept
thesis: "The three spheres of being — chö-ku (chos sku, dharmakāya), long-ku (long sku, sambhogakāya), trül-ku (sprul sku, nirmāṇakāya) — are the Buddhist trikāya as the Aro gTér books frame them: chö-ku as the sphere of unconditioned potentiality (emptiness), long-ku as the sphere of intangible appearance (energy — the infinite display of light and sound), trül-ku as the sphere of realized manifestation (physicality). Roaring Silence Ch.8 installs them as the structural frame for the three auxiliary exercises supporting lha-tong (mind/voice/body → chö-ku/long-ku/trül-ku), and for integration — 'nothing separate from the nondual state' — because the three spheres are indestructible precisely because they have never been separate from the nondual condition. Spectrum of Ecstasy Ch.1 introduces them as three lenses on one reality, and distinguishes within trül-ku a 'sphere of relative manifestation' (dualistic) from a 'sphere of realized manifestation' (nondual) — the same sphere seen through a filtered vs unfiltered lens. SoE Ch.3 supplies a third mapping — the triad tawa/gompa/chodpa (view/meditation/action) onto chö-ku/long-ku/trül-ku — binding the path's three-aspect frame to the three-spheres ontology. Also called the 'three vajras.' Kuntuzangmo is the dharmakaya (chö-ku) form in the Aro gTér lineage."
status: 🌱
domain: [dzogchen, phenomenology, tantra]
importance: 7
confidence: established
tags: [foundational, trikaya, nyingma, tibetan-term, dzogchen-technical, iconography, aro-lineage]
aliases: [trikāya, three kayas, three bodies, chos sku, long sku, sprul sku, dharmakāya, sambhogakāya, nirmāṇakāya, three vajras, chö-ku, long-ku, trül-ku, cho-ku, trul-ku, sphere of unconditioned potentiality, sphere of intangible appearance, sphere of realized manifestation, sphere of relative manifestation]
sources: [raw/roaring-silence/Roaring Silence - 08 Beyond Emptiness.md, raw/roaring-silence/Roaring Silence - 10 The Dimension of Nongradual Approach.md, raw/spectrum-of-ecstasy/06-ch01-rainbow-of-liberated-energy.md, raw/spectrum-of-ecstasy/08-ch03-view-meditation-and-action.md]
updated: 2026-04-23
---

# Three Spheres of Being

The **three spheres of being** — *chö-ku*, *long-ku*, *trül-ku* (the Buddhist **trikāya** — "three bodies") — are developed in both Aro gTér handbooks. *[[Roaring Silence]]* Ch.8 introduces them as the structural frame for the three auxiliary exercises supporting [[Lha-tong|lha-tong]] and for [[Integration|integration]]. *[[Spectrum of Ecstasy]]* Ch.1 introduces them as the book's conceptual framework — three lenses on the same reality, with a crucial dualistic/realized split within trül-ku.

## The Three Spheres

Ch.8's definitions:

| Sphere | Tibetan | Sanskrit | Dimension |
|---|---|---|---|
| Body of reality | *chö-ku* (chos sku) | dharmakāya | **Unconditioned potentiality** — emptiness |
| Body of enjoyment | *long-ku* (long sku) | sambhogakāya | **Intangible appearance** — energy; infinite display of light and sound |
| Body of manifestation | *trül-ku* (sprul sku) | nirmāṇakāya | **Realized manifestation** — physicality |
...
| Sphere | Ch.8 Exercise | Practice |
|---|---|---|
| Chö-ku (mind) | Exercise 6 | Visualize the white Tibetan *A* |
| Long-ku (voice) | Exercise 7 | Sing the sound of *A* ("ah") |
| Trül-ku (body) | Exercise 8 | Vajra posture (under the principle of [[Nalma\|nalma]]) |
...
| Lens | Name | Phenomenological Register |
|---|---|---|
| Nondual | **Sphere of realized manifestation** | *"self-perfected, evident, substance of the world"* — world directly perceived |
| Dualistic | **Sphere of relative manifestation** | world perceived through dualistically-filtered sense fields: *"filtered seeing, filtered hearing, filtered smelling, filtered tasting, filtered touching, and filtered thinking"* |

In the West, Ch.1 notes, the filtered-thinking sense field overrides the other sense fields — a culturally distinctive pathology of [[Thought as Sense|cognition-as-sense]] becoming the dominant filter.
...
- The *phenomenological register* is [[Namthog|namthog]] as movement — specifically the [[gYo-wa|gYo-wa]] of lha-tong: namthogs with color, texture, tone.
...
- The *experiential access* in Ch.8 is through the [[Vajra Posture|vajra posture]] and the [[Nalma|nalma]] principle — body-level exhaustion of neurotic concept-involvement.
...
| Path Aspect | Tibetan | Three-Sphere | Sanskrit |
|---|---|---|---|
| **View** | *tawa* (lTa ba) | **Chö-ku** | dharmakāya |
| **Meditation** | *gompa* (sGom pa) | **Long-ku** | sambhogakāya |
| **Action** | *chodpa* (spyod pa) | **Trül-ku** | nirmāṇakāya |
...
|---|---|---|
| Mind / Voice / Body exercises | RS Ch.8 (Ex.6 / Ex.7 / Ex.8) | Practice modality |
| Patience / Vitality / Generosity | RS Ch.10 Ten Paramitas Q&A | Ethical expression |
| **View / Meditation / Action** | **SoE Ch.3** | **Path structure** |
...
| Paramita | Three-Sphere | Dimension |
|---|---|---|
...
- [[View Meditation Action]] — the tawa/gompa/chodpa triad mapped to the three spheres (SoE Ch.3)
- [[Spectrum of Ecstasy - 08 Ch.3 View Meditation and Action]] — source: the view/meditation/action mapping
- [[Ten Paramitas]] — the paramita-mapping to the three spheres (Ch.10)
- [[Kuntuzangmo]] — the Aro gTér dharmakāya (chö-ku) form
- [[Nonreferentiality]] — the phenomenological register of chö-ku
- [[Lha-tong]] — the practice that is the chö-ku-grounded discovery of long-ku
- [[Namthog]] — what arises and dissolves at the long-ku level
- [[gYo-wa]] — the movement at the long-ku level that lha-tong observes
- [[Vajra Posture]] — the trül-ku level exercise; part of trül'khor naljor
- [[Nalma]] — the principle of the trül-ku level practice
- [[Integration]] — the non-separation of the three spheres from the nondual state
- [[Fluxing Web]] — the ontology most visibly at long-ku level
- [[Transmission in Dzogchen]] — the mind-transmission that begins at the chö-ku level
- [[Roaring Silence - 08 Beyond Emptiness]] — source: the three-sphere frame for the lha-tong auxiliary exercises
- [[Roaring Silence - 10 The Dimension of Nongradual Approach]] — source: paramita-to-three-spheres mapping
- [[Spectrum of Ecstasy - 06 Ch.1 Rainbow of Liberated Energy]] — source: three-lenses framing; relative/realized split within trül-ku; symbol as long-ku arising from chö-ku
- [[Symbol]] — Tantric symbol as long-ku-level manifestation; structurally positioned by the three spheres
- [[Five Elements]] — the long-ku-level five-coloured-light display of the five elements
- [[Dzogchen]] — the view within which the three spheres are read as indestructibly non-separate
