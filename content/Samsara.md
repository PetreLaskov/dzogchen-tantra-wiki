...
- This connects directly to [[Referentiality|referentiality]]: samsara is what referentiality *does* at the level of desire-production. The continuous shift of reference points prevents the self-substantiation from ever being complete, which is what keeps the substantiation-operation running.
...
**The asymmetry**: one does not progress from samsara → practitioner → enlightenment by accumulating better discrimination. The practitioner's capacity to tell the difference is *not* what becomes the enlightened state's "perfect discrimination" — the enlightened state is the *disappearance* of the distinction. This is the [[Nongradual Approach|nongradual approach]] applied to the practitioner / nondual transition.
