---
type: concept
thesis: "Tsam (*mTshams*) is the Tibetan word usually rendered as 'retreat' but whose literal meaning is **confines** — a reframe that shifts the concept from *going away from ordinary life* to *establishing the bounds within which one practices*. A tsam can last an hour, a day, a week, a month, a year, or the traditional three years; can be solitary or in a group; can be open (contact with the outside world) or closed. In *Roaring Silence* Ch.11 the tsam structure is treated as the practitioner's chief tool for breaking through plateaus in practice, with the explicit weekend-solitary ceiling for anyone practicing without a teacher's advice. The *mTshams*-as-confines etymology also grounds the view-level claim that *retreat is wherever you are* — the tall pointed Lama hat with long earflaps represents the cave; your retreat is the confines you establish, not a geographical elsewhere."
status: 🌱
domain: [meditation-practice, tibetan-buddhism]
importance: 6
confidence: established
tags: [retreat, tibetan-term, confines, practice-structure, ch11, q-and-a, group-retreat, solitary-retreat]
aliases: [mTshams, retreat, confines, dharma retreat, tsam retreat, solitary retreat, group retreat, mountain retreat]
...
| Duration | Structure |
|---|---|
| **Half-day** | Starts after lunch, finishes the following morning; night is passed sleeping in the retreat room |
| **Day** | Begins an hour or so before sleep, continues through the following day, finishes an hour or so after waking the day after |
| **Weekend solitary** | Friday night till Monday morning |
...
| Structure | Relation to tsam |
|---|---|
| **Daily practice** | The baseline continuity tsam intensifies; tsam extends daily practice, does not replace it |
| **Jé-thob** ([[Jé-thob]]) | The post-meditation period; a mini-tsam bounded around each daily sit |
| **[[Ngöndro]]** | The preliminary practices — the larger-scale "confines" before actual-Sem-dé practice |
| **Three-year retreat** | The traditional Tibetan long-confines; outside the book's practical scope; requires teacher |
| **Lamrim-style graduated path** | Not the *Roaring Silence* frame; tsam in this book is practice-intensification, not path-stage |
...
- [[Jé-thob]] — the post-meditation "mini-retreat" around each sit
- [[Shi-nè]] — the practice tsam intensifies
- [[Meditation Isn't Getting Used To Is]] — the adage retreats serve without altering
- [[Ngöndro]] — the larger-scale preliminary practice context
