---
type: entity
thesis: "Ekajati (Tib. mug nag rGyal mo, 'the maroon queen'; also 'Single-plait Mother' or 'Single-braid Mother') is the principal Protector (Dharmapāla) of the Nyingma school, and specifically of Dzogchen's innermost Tantra. She is pre-eminent in a group of three Protectors known as Ma-za-dor-sum (Ma = Ekajati; Za = Rahula/Lord of Lightning; Dor = Dorje Legpa/Vajra Sadhu/the Benign Thunderbolt). In SoE Ch.7 her iconographic specific — grasping a ripped-out heart in her hand — is given the water-element function: 'symbolic of how justification should be uncompassionately murdered.' The Aro gTér preserves a rare cross-function form: a special Ekajati manifesting as Yeshé Tsogyel, practised as yidam rather than as Protector — bringing Ekajati into the direct-identification register for sadhana rather than only the protective-invocation register."
status: 🌱
domain: [nyingma, tantra, lineage]
importance: 5
confidence: established
tags: [tibetan-term, vajrayana, dharmapala, protector, yidam, aro-lineage, dzogchen, nyingma]
aliases: [mug nag rGyalmo, mug nak gyalmo, Single-plait Mother, Single-braid Mother, Maroon Queen, Ekadzati, Tsomo Rigchik, One-eyed Mother, Ma]
...
*[[Spectrum of Ecstasy]]* Ch.7 introduces Ekajati in the specific context of the [[Justification|justification]] teaching:
...
| Abbrev | Full name | Title / Description |
|---|---|---|
| **Ma** | Ekajati | Single-plait Mother / Maroon Queen |
| **Za** | Rahula | Lord of Lightning |
| **Dor** | Dorje Legpa | Vajra Sadhu / the Benign Thunderbolt |
| **Sum** | — | "these three" |
...
- **Yidam function**: the practitioner *identifies* with the yidam via [[Vajra Pride|vajra pride]]; the relationship is self-as-yidam.

**Aro's move** brings Ekajati into the yidam register, permitting direct identification-practice with her wisdom-aspect. The connection to [[Yeshé Tsogyel|Yeshé Tsogyel]] (the origin-figure of the Aro gTér via her gTérma through Aro Lingma) is structurally unique to Aro.
