---
type: concept
thesis: "The base (starting point) of Dzogchen is the experience of nonduality — at minimum, 'a series of brief flashes.' Without this base the path is inaccessible: one is 'barred by the path itself.' It is not imposed by tradition but a self-existent experiential demand — Dzogchen's methods cannot take hold in a ground that has not yet been glimpsed. The Four Naljors and Tantric ngöndro are two different routes that deliver the practitioner to this base."
status: 🌱
domain: [dzogchen, meditation-practice]
importance: 8
confidence: established
tags: [foundational, prerequisite, view, self-existent-demand]
aliases: [starting point of Dzogchen, base of Dzogchen, Dzogchen base, nondual base]
...
The **base** (or **starting point**) of [[Dzogchen]] is the **experience of nonduality.** It is what ngöndro — whether [[Four Naljors]] or [[Tantric Ngöndro|Tantric ngöndro]] — exists to deliver. Without it, Dzogchen methods are "merely affectations."
...
- **Primordial qualification holds anyway.** Because the [[Natural State|natural state]] is the primordial condition of the individual, "everyone is primordially qualified as having the requisite base." Latent capacities from past-life experience mean the flashes can arise unpredictably.
...
Ch.1 footnote 1 identifies **emptiness** in this context with **[[Mi-thogpa|mi-thogpa]]** — the state without thought. Experientially, the Tantric base (emptiness) and the Dzogchen base (nonduality) are not strangers: the nondual taste arises *in* mi-thogpa, when thought's occlusive monopoly on cognition thins.
