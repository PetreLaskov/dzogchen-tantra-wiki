---
type: concept
thesis: "Pawo (dPa' bo) — 'hero' or 'warrior' — is the Tibetan for Sanskrit daka, the enlightened masculine principle / male tantric adept. Paired with Khandro (the feminine, spatial, feeling-quality aspect), the Pawo constitutes the outer, physical, dynamic aspect of each of the five elements. Ch.5: 'This pawo characteristic applies to the dynamic qualities of the elements: the colossal enduring ruggedness of earth; the powerful surging force of water; the bright lascivious incendiary hunger of fire; the all-pervasive relentless turbulence of air; the fundamental fecundity of space.' Ch.6–10 develop each element's Pawo-Khandro pair as a full chapter. Pawo and Khandro are not separate beings but two complementary sides of the same elemental energy."
status: 🌱
domain: [tantra, nyingma]
importance: 6
confidence: established
tags: [tibetan-term, vajrayana, daka, five-elements, wisdom-being, foundational]
aliases: [dpa' bo, daka, hero, warrior, pawos]
sources: [raw/spectrum-of-ecstasy/06-ch01-rainbow-of-liberated-energy.md, raw/spectrum-of-ecstasy/10-ch05-reading-the-fields-of-our-energies.md, raw/spectrum-of-ecstasy/11-ch06-yellow-khandro-pawo-display.md, raw/spectrum-of-ecstasy/12-ch07-white-khandro-pawo-display.md, raw/spectrum-of-ecstasy/13-ch08-red-khandro-pawo-display.md, raw/spectrum-of-ecstasy/14-ch09-green-khandro-pawo-display.md, raw/spectrum-of-ecstasy/15-ch10-blue-khandro-pawo-display.md, raw/spectrum-of-ecstasy/16-ch11-five-fold-display.md, raw/spectrum-of-ecstasy/18-ch13-dancing-in-the-space-of-the-earth-and-sky.md]
updated: 2026-04-24
---
...
- **[[Khandro|Khandro]]** = spatial / feeling-quality / inner / sky-goer / feminine aspect; the *glow, lustre, or ambience of the elements, their innate vividness*; in emotions: *the feeling-tone itself*; *the atmosphere*.
...
- **Earth Pawo** — *the colossal enduring ruggedness of earth* (yellow)
- **Water Pawo** — *the powerful surging force of water* (white)
- **Fire Pawo** — *the bright lascivious incendiary hunger of fire* (red)
- **Air Pawo** — *the all-pervasive relentless turbulence of air* (green)
- **Space Pawo** — *the fundamental fecundity of space* (blue)
...
- **Geological-historical inversion** — Tibet as once-ocean, now highest plateau; fossilised conches on the plateau becoming Tantric ritual horns and [[Ngak'phang|ngak'phang]] spiral earrings.
...
At the [[Three Spheres of Being|long-ku]] level, the pawos appear as visionary wisdom-beings — male enlightened figures paralleling the khandros. In this mode they function as yidams for sadhana practice.

[[Kuntuzangmo|Kuntuzangpo]] (Samantabhadra) is the chö-ku (dharmakāya) pawo in the Nyingma tradition — the male counterpart of Kuntuzangmo.
...
- [[Khandro]] — the feminine, inner-spatial counterpart; Pawo-Khandro as five-fold symmetry
- [[Five Elements]] — the substrate of the pawo-khandro pairs
- [[Khyil-khor]] — the mandalic composition in which pawos and khandros are arranged
- [[Spectrum of Ecstasy - 06 Ch.1 Rainbow of Liberated Energy]] — source: compressed introduction of the pawo-khandro framework
- [[Spectrum of Ecstasy - 11 Ch.6 Yellow Khandro-Pawo Display]] — source: earth-pawo full development
- [[Spectrum of Ecstasy - 12 Ch.7 White Khandro-Pawo Display]] — source: water-pawo full development
- [[Spectrum of Ecstasy - 13 Ch.8 Red Khandro-Pawo Display]] — source: fire-pawo full development
- [[Spectrum of Ecstasy - 14 Ch.9 Green Khandro-Pawo Display]] — source: air-pawo full development
...
- [[Pema]] — fire-pawo's symbol (lotus)
- [[Thunderbolt Sword]] — air-pawo's symbol (lightning-motion)
- [[Dorje Trollo]] — the air-pawo at the awareness-being level; thunderbolt wrath
- [[Khorlo]] — space-pawo's symbol (the ground-circle transcending location/direction/form/time/space)
- [[Wisdom of Equanimity]] — the wisdom-mode of earth-pawo/khandro
- [[Mirror-Wisdom]] — the wisdom-mode of water-pawo/khandro
- [[Discriminating Awareness]] — the wisdom-mode of fire-pawo/khandro
- [[All-Accomplishing Wisdom]] — the wisdom-mode of air-pawo/khandro
- [[Dharmadhatu Wisdom]] — the wisdom-mode of space-pawo/khandro; the ground-wisdom
- [[Ngak'phang]] — fossilised-conch earrings as wearable earth-pawo teaching
- [[Spectrum of Ecstasy - 16 Ch.11 Five-fold Display]] — source: Ch.11 definitional refinement (dynamism; activity-from-feeling-tone; direction-in-time); Khandro-pawo-nyi-da-me-long-gyud named
- [[Wrathfulness]] — the pawo-register at intensified-activity
- [[Three Terrible Oaths]] — the stance aligning pawo-activity with what-is
- [[Spectrum of Ecstasy - 18 Ch.13 Dancing in the Space of the Earth and Sky]] — source: Ch.13 compressed definition; female-tantrika-vow; androcentric-bias analysis; Dorje Sempa as peaceful-register pawo
- [[Dance]] — the non-dual structural-relation pawo-khandro exemplifies
- [[Non-Dual Multiplicity]] — the metaphysical claim pawo-khandro dance operationalises
- [[Dorje Sempa]] — the peaceful-register pawo at awareness-being level (Ch.13 iconographic description)
