---
type: concept
thesis: "The natural state is what is already the case — the basis of what we are, prior to and underneath all manipulation. Dzogchen's entire instruction is 'remain in the natural state'; the Four Naljors are the four methods of such remaining. The natural state is not produced by practice, nor reached by effort — it is the condition practice ceases interfering with."
status: 🌿
domain: [dzogchen]
importance: 9
...
- **Etymology of naljor**: *rNal ma* (natural state) + *'byor pa* (remaining). A [[Naljor|naljor]] is "natural state remaining"; the [[Four Naljors]] are four methods of such remaining.
...
- **Lion's roar of reality**: the natural state is not fragile — it is the [[Lion's Roar of Reality|self-existent proclamation of self-existent confidence]], "the empty confidence that has no need of [[Reference Points|reference points]]."
...
- [[Dzogchen]] — the view that posits the natural state
- [[Four Naljors]] — methods of remaining in it
- [[Naljor]] — the term "natural state remaining"
- [[Lion's Roar of Reality]] — its self-existent proclamation
- [[Reference Points]] — what the natural state's confidence does without
