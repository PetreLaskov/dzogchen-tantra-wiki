---
type: source
thesis: "Ch.10 is the final chapter of *Roaring Silence*'s main body — completing Part Three and the book's exposition of the Four Naljors. It introduces **lhun-drüp** (lhun sGrub, 'spontaneous self-perfectedness') as the fourth and final naljor — the integration of nyi'mèd with every aspect of being, beyond practice, with no method except continuing in the nondual presence of awareness in the efflorescence of every moment. The chapter's framing argument — the **nongradual approach** — refuses the gradualist reading the first nine chapters constructed: the linear sequence (shi-nè → lha-tong → nyi'mèd → lhun-drüp) is *only* a pedagogical necessity imposed by the sentence-grammar of exposition. Experience does not conform to the linear model — flashes of lha-tong or nyi'mèd can occur to anyone with or without meditative experience, because 'enlightenment is our natural state... it sparkles through the unenlightenment that we continually fabricate.' Ch.10 also establishes that the Four Naljors are themselves *ngöndro* (principal means of entry) for Sem-dé proper, whose actual practices are the **Four Ting-ngé'dzins** (nè-pa, mi-gYo-wa, nyam-nyid, lhun-drüp); maps the Four Naljors onto the **Mahāmudrā Four Yogas**; provides the naljor etymology (nalma + jorpa = 'natural state remaining'); and develops the Ten Paramitas across the four naljors as a Q&A frame."
status: 🌿
domain: [dzogchen, meditation-practice]
importance: 9
confidence: established
tags: [roaring-silence, chapter, part-three, lhun-drup, nongradual, source]
aliases: [Roaring Silence Ch.10, RS 10, Ch.10 The Dimension of Nongradual Approach]
sources: [raw/roaring-silence/Roaring Silence - 10 The Dimension of Nongradual Approach.md]
updated: 2026-04-23
---
...
| Term | Sutra | Tantra | Dzogchen |
|---|---|---|---|
| **Shi-nè** | Shamatha (stabilization) | Linked with visualization; "there is a sense in which emptiness and form must be unified" | "Finding oneself in the space of Mind without content while maintaining presence of awareness" |
| **Lha-tong** | Vipashyana (insight) | Linked with visualization | "Reintegrating the presence of awareness with the movement of whatever arises in Mind" |
| **Nyi'mèd** | — | Linked with visualization; unification must be *done* | "The recognition of *ro-chig*, the one taste of emptiness and form" |
| **Lhun-drüp** | — | — | **Unique to Dzogchen.** "Spontaneous self-perfectedness." |
...
- **Nakedness of being** — *jen-par shar-wa* (rJen par shar ba). The Ch.4 *nakedness* register (see [[Rigpa]]) extended here.
...
- **The only method is non-method** — *continuing in nondual presence of awareness in the efflorescence of every moment*. No technique, no exercise, no gesture-to-perform.
...
- [[Four Naljors]] — the curriculum now fully specified with Ch.10
- [[Lhun-drüp]] — the fourth and final naljor, Ch.10's central new concept
- [[Nongradual Approach]] — the methodological framing
- [[Four Ting-ngé'dzins]] — footnote 3; the actual Sem-dé practices the Four Naljors prepare
- [[Inspiration]] — Ch.10's definition
- [[Ten Paramitas]] — the paramita-naljor mapping in Q&A
- [[Naljor]] — etymology confirmed (nalma + jorpa)
