---
type: source
thesis: "Spectrum of Ecstasy Ch.11 'Five-fold Display' — the Q&A commentary chapter added for the 2003 revision, retrospectively covering Part Two's five element-chapters (Ch.6–10) with questioner-driven refinements. Key consolidations: elements indivisible and equally present (the pure elements in the central channel); balance is not a Tantra/Dzogchen concept; sparkling-through and distortions are both the enlightened state; secondary colours of the spectrum (shyness, guilt) as element-interaction compounds (earth+air); clarity-synonym expansion (Mirror-Wisdom glossed through 17 English near-synonyms); wrathfulness distinguished from anger (activity/energy/movement/directness/velocity/acceleration/change/contrast — and its wisdom-display as vajra-whimsy in Tsogyel Trollo); anger as 'the most extreme manifestation of duality'; element stickiness ranking (fire least, space most sticky); fire-burnout → space-neurosis as the manic-depression axis; Three Terrible Oaths unpacked as 'totality or completeness of our context… ecstatic appreciation of every moment'; 'recognition of fundamental insecurity is totally secure'; chutzpah as tantrika quality; devotion as escape-clause for neuroses; Padmasambhava's deathlessness reinterpreted as 'every Lama of the lineage can become Padmasambhava'; khandro/pawo definitional clarification — 'pawo means the actual physical elements — their dynamism. Khandro means the glow, lustre, or ambience of the elements — their innate vividness'; dance as 'oscillation of unitary reality with multiplistic reality'; Khandro-pawo-nyi-da-me-long-gyud named as the Aro gTer teachings on khandro-pawo reflection and relationship-as-spiritual-practice; 'samsara only operates behind closed doors'; thig-le (bindu) named as 'the essence of the elements; the matrix of primal creativity'; sKu-mNye named as psycho-physical exercises from Dzogchen Long-de of the Aro gTer; emotional-napalm illustrated through the Devon-car vignette; 'elements on the fringes come to resemble each other' as Ch.11's organising meta-thesis."
status: 🌱
domain: [nyingma, tantra, phenomenology, meditation-practice]
importance: 7
confidence: established
tags: [source-page, spectrum-of-ecstasy, aro-lineage, five-elements, qanda, five-fold-display]
aliases: [SoE Ch.11, Five-fold Display, Ch.11 Spectrum of Ecstasy]
...
The mechanism-of-neurosis requires opacity to itself. [[Shi-nè|Sitting]] supplies the transparency under which the opacity-operation fails. The practice-gesture is *not-avoidance*, not *analysis*.
...
**Emotional napalm**: hot desire that, when the conceptual-apparatus seizes on it, sticks to the vision-of-self-and-world rather than being experienced as desire-without-grasping. The [[Fear of Isolation|fire-element neurosis]] diagnostic in vivid illustration.
...
- [[Spectrum of Ecstasy - 11 Ch.6 Yellow Khandro-Pawo Display]] — earth chapter referred back to
- [[Spectrum of Ecstasy - 12 Ch.7 White Khandro-Pawo Display]] — water chapter referred back to
- [[Spectrum of Ecstasy - 13 Ch.8 Red Khandro-Pawo Display]] — fire chapter referred back to
- [[Spectrum of Ecstasy - 14 Ch.9 Green Khandro-Pawo Display]] — air chapter referred back to
- [[Spectrum of Ecstasy - 15 Ch.10 Blue Khandro-Pawo Display]] — space chapter referred back to
- [[Five Elements]] — the chapter's principal subject
- [[Khandro]] — Ch.11 definitional refinement (glow/lustre/ambience/feeling-tone/atmosphere)
- [[Pawo]] — Ch.11 definitional refinement (dynamism/activity-from-feeling-tone)
- [[Three Terrible Oaths]] — Ch.11's deepened exposition (totality of context; ecstatic appreciation)
- [[Wrathfulness]] — the wrathfulness-vs-anger distinction
- [[Tsogyel Trollo]] — the vajra-whimsy wisdom-display form; Yeshe Tsogyel as Dorje Trollo
- [[Dorje Trollo]] — the Ch.9 lineage-figure re-invoked
- [[Thig-le]] — footnote 6's definition
- [[Six Realms]] — footnote 1's psychological-frame reading
- [[Living the View]] — the practice-register
- [[Wisdom of Equanimity]] — the earth-khandro equanimity register
- [[Mirror-Wisdom]] — clarity-synonym expansion
- [[Discriminating Awareness]] — fire-element burnout → space-neurosis
- [[All-Accomplishing Wisdom]] — the Three Terrible Oaths' air-register
- [[Dharmadhatu Wisdom]] — *"dharmadhatu = the dimension of space, the fundamental creative space of reality"*
- [[Fear of Poverty]], [[Fear of Isolation]], [[Fear of Obliteration]] — element-specific fears clarified in Ch.11
- [[Bewilderment]] — space as most-sticky neurosis; ground-depletion
- [[Justification]] — Ch.7's licensing-operation; Ch.11's "living the view" practice-gesture
- [[Idiot Compassion]] — fire-element failure-mode referenced
- [[Embracing Emotions as the Path]] — the book's central methodological thesis, clarified through Q&A
- [[Samsara]] — *"only operates behind closed doors"*
- [[Shi-nè]] — the simply-sitting practice
