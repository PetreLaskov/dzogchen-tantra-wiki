---
type: concept
thesis: "gTér / gTérma (gTer, gter ma) — 'treasure' — refers to spiritual teachings hidden by Padmasambhava and Yeshé Tsogyel to be revealed in a later era by a destined gTértön (treasure-revealer) when conditions are ripe. Spectrum of Ecstasy Ch.1 footnote 5 supplies the authoritative three-category taxonomy: sa gTer (earth treasures — physical texts or objects); gong gTer (mind treasures — concealed within the Mind-continuum of the twenty-five disciples of Padmasambhava, discovered through revelation); dag-ngang gTer (treasures of pure vision — symbolic material arising directly from the nature of Mind itself). gTérton are incarnations of the twenty-five disciples of Padmasambhava (or disciples of their disciples). The gTér mode is a characteristic Nyingma transmission — distinct from the continuous-oral-transmission kama — and the Aro gTér is one such cycle."
status: 🌱
domain: [nyingma, lineage]
importance: 6
confidence: established
tags: [tibetan-term, terma, gterton, transmission, nyingma]
aliases: [gTer, gTerma, terma, treasure, hidden teachings, gTerton, terton, treasure-revealer, sa-gter, gong-gter, dag-ngang-gter]
sources: [raw/spectrum-of-ecstasy/06-ch01-rainbow-of-liberated-energy.md, raw/roaring-silence/Roaring Silence - 13 Glossary.md]
updated: 2026-04-23
---
...
gTér discovery is a clear instance of the [[Symbol|Tantric symbol]] theory: the gTértön's discovery is *"concomitant with direct awareness of 'that' which is symbolised, and contains the motivation to communicate it as a method of liberation."* The gTértön is not inventing — they are revealing what is already there. This is structurally parallel to (and in many cases identical with) the symbol's "spontaneous manifestation of what is symbolised."
