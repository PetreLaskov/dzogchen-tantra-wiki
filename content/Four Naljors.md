---
type: concept
thesis: "The Four Naljors (Aro Naljor-zhi) are the ngöndro — preliminary practices — for Dzogchen Sem-dé in the Aro gTér lineage: shi-nè, lha-tong, nyi'med, and lhun-drüp. Because 'naljor' literally means 'natural state remaining,' the Four Naljors are four methods of remaining in the natural state, progressively dissolving the obstacles (thought-attachment, duality, effort) to recognizing what is already the case."
status: 🌿
domain: [dzogchen, meditation-practice]
importance: 9
confidence: established
tags: [ngondro, foundational, aro-lineage, sem-de, method]
aliases: [Aro Naljor-zhi, Naljor-zhi, Four Naljors of Aro, Sem-dé ngöndro]
sources: [raw/roaring-silence/Roaring Silence - 00c Introduction.md, raw/roaring-silence/Roaring Silence - 01 Sky and Mind.md, raw/roaring-silence/Roaring Silence - 03 Presence and Awareness.md, raw/roaring-silence/Roaring Silence - 07 Journey into Vastness.md, raw/roaring-silence/Roaring Silence - 09 The Vivid Portal.md, raw/roaring-silence/Roaring Silence - 10 The Dimension of Nongradual Approach.md, raw/roaring-silence/Roaring Silence - 13 Glossary.md]
updated: 2026-04-23
---
...
- **[[Nyi'med|Nyi'mèd]]** (gNyis med) — *the recognition of ro-chig, the one taste of emptiness and form.* Cannot be practiced directly; manifests as the natural alternation between nè-pa and gYo-wa matures. Introduced in Ch.9 as the "vivid portal" of Dzogchen.
...
- **[[Tantric Ngöndro]]** (four 100,000 practices) — the **symbolic** method of arriving at the [[Base of Dzogchen|base of Dzogchen]]. Has the character of Tantra; its innermost practice is the heart of Tantra.
...
- **The trigger is empirical**, not chronological. [[Stabilized Shi-nè|Stabilized shi-nè]] (mental events no longer arising for substantial periods) + the emergence of sleepy shi-nè (mental events absent, presence of awareness also absent) is the marker-pair that triggers the transition.
...
- The trigger is again empirical, not chronological — the establishment of natural alternation between [[Nè-pa|nè-pa]] (abiding) and [[gYo-wa|gYo-wa]] (movement).
- The third naljor has a characteristic fruit: **[[One Taste|one taste]]** (*ro-chig*) — the lack of difference between the quality of experiencing emptiness and the quality of experiencing form.
...
Ch.10 *The Dimension of Nongradual Approach* completes the curriculum with [[Lhun-drüp|lhun-drüp]] ("spontaneous self-perfectedness") as the fourth naljor — **unique to Dzogchen** (the first three have Sutric or Tantric analogues; lhun-drüp does not). The chapter also reframes the whole Four Naljors sequence under the [[Nongradual Approach|nongradual approach]]:
...
Ch.10 footnote 3 reveals a structural layer this wiki did not previously have: the Four Naljors are *ngöndro* for a further curriculum — the **[[Four Ting-ngé'dzins|Four Ting-ngé'dzins]]** (meditative absorptions / samadhis), which are the *actual* practice of Dzogchen Sem-dé.
...
*Roaring Silence* presents the Four Naljors in handbook form. The authors caution: the practices cannot be encapsulated in a handbook; eventual [[Transmission in Dzogchen|transmission]] from a qualified Lama is required. Working alone for more than a few years "would prove too difficult and discouraging."
