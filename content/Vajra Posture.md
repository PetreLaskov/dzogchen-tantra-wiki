---
type: concept
thesis: "Vajra posture (thunderbolt posture) is Exercise 8 of *Roaring Silence* Ch.8 — the body-level practice supporting lha-tong within the three spheres of being (mind/voice/body) sequence. Its shape mirrors the shape of the vajra (dorje) and symbolizes the indestructibility of the primordial state of awareness. Its operating principle is nalma — rapid exhaustion of neurotic concept-involvement. Practical design: the posture is made intense enough to collapse within seconds; the faster nalma is reached, the faster the physical recovery, so the practitioner is left energized rather than sleepy. Part of the trül'khor naljor (yantra yoga) system; the Aro gTér Sem-dé version is from a Dzogchen framework (not Anuttarayoga Tantra) and is therefore taught openly rather than kept secret. Strong safety contraindications: heart conditions, high blood pressure, pregnancy, menstruation."
status: 🌱
domain: [meditation-practice, dzogchen]
importance: 6
confidence: established
tags: [practice-exercise, body, trul-khor, ch8, aro-lineage, contraindication]
aliases: [thunderbolt posture, dorje posture, Exercise 8, trül'khor posture, Aro Sem-dé trül'khor]
sources: [raw/roaring-silence/Roaring Silence - 08 Beyond Emptiness.md]
updated: 2026-04-23
---
...
It is the **body-level practice** in the [[Three Spheres of Being|three-sphere sequence]] (mind / voice / body) that Ch.8 installs to support [[Lha-tong|lha-tong]] when presence is lost and Ex.6 (visualize *A*) and Ex.7 (sing *A*) have not resolved the distraction.
...
1. **Squat on tiptoe** — balls of feet and heels touching. Balance with fingertips forward.
2. **Place palms on knees, straighten arms.** Push knees down; spread knees apart; straighten back. Lean back rather than lose vertical.
3. **Raise hands above head** — palms together about an inch above head, fingers pointing directly upward.
4. **Simultaneous counter-push** — push hands up AND push elbows back with equal force, so the arms tremble but do not rise or separate.
5. **Raise self until legs form the same angle as arms.** Remain until collapse — typically within a minute.
6. **Fall back onto a cushion still stressing the arms**; then fall into corpse posture; let go and let be.
