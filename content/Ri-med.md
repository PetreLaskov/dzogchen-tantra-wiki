---
type: concept
thesis: "Ri-med (ris med) is the Tibetan term for 'without bias' — commonly mistranslated as 'eclectic.' Spectrum of Ecstasy Ch.5 introduces it as the 19th-century Tibetan movement that flourished as a renaissance of spirituality — not through blending traditions but through lineage-preserving mastery of multiple schools in their own native styles. The paradigmatic figure is Jamyang Khyentse Wangpo (1820–1892), who — when giving a Nyingma transmission — gave it as a Nyingmapa; when giving a Sakya transmission — as a Sakyapa. The Ri-med principle is methodologically load-bearing for the book's stance on symbolic systems: authentic systems are self-complete and are distorted by synthesis. The practitioner can work with multiple systems serially but not in combination — 'some dreadful stew.' Extends even across the Buddhist/Bon divide: Buddhist Lamas mastered Bonpo traditions and vice versa. Etymology: ri (bias) + med (not) = not-biased; not 'eclectic' (which implies selecting from multiple sources to form a new whole)."
status: 🌱
domain: [nyingma-lineage, tibetan-buddhism, methodology]
importance: 5
confidence: established
tags: [tibetan-term, 19th-century, lineage, methodology, non-sectarian]
aliases: [ris med, Rimé, Rime, non-sectarian movement, non-sectarian, without-bias movement]
sources: [raw/spectrum-of-ecstasy/10-ch05-reading-the-fields-of-our-energies.md]
updated: 2026-04-23
---
...
1. ✅ Master multiple lineages.
2. ✅ Teach each lineage in its own characteristic style.
3. ✅ Refuse partisan bias for or against any lineage.
4. ❌ Do NOT blend, synthesise, or flatten lineages into a uniform teaching.
5. ❌ Do NOT import elements from one lineage into another.
